...
{
    public class DailyServiceReviewFormQueryTemp
    {
        ...
        public string? ManufacturingMonth { get; set; } = default!;
        ...
        public string? InternalModelCode { get; set; } = default!;
        public string? VehicleType { get; set; } = default!;
        public string? Fuel { get; set; } = default!;
        public string? MISInterval { get; set; } = default!;
